...
export default class App {
    ...
    constructor({ signingSecret, endpoints, agent, clientTls, receiver, convoStore, token, botId, botUserId, authorize, orgAuthorize, logger, logLevel, ignoreSelf, clientOptions, processBeforeResponse, clientId, clientSecret, stateSecret, installationStore, scopes, installerOptions, }?: AppOptions);
    /**
